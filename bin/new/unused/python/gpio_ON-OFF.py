...
# GPIO pin Blinky code for Raspberry Pi
# Written in Python 2.7.3

import RPi.GPIO as GPIO     ## Import GPIO Library
import time                 ## Import 'time' library (for 'sleep')
 
## Define function named pin_Blink()
def pin_Blink(pin, numTimes, delay):
...
## Call pin_Blink() function for GPIO pin
pin_Blink(int(pin), int(nTimes),float(delay))
