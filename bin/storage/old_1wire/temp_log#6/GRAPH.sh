...
Hall="-A -y 1:5 --right-axis 1:0 -s -3h -D -E -w 955 -h 350"
...
# 	twilight1 - sunset to dusk
# 	darkness1 - dusk to midnight
# 	darkness2 - midnight to dawn
# 	twilight2 - dawn to sunrise
...
${Hall} \
--title "IN CASA" \
DEF:T1temp=TH.rrd:T1:AVERAGE \
CDEF:TWL1=LTIME,86400,%,$SUNS,GT,INF,UNKN,T1temp,*,IF \
CDEF:TWL2=LTIME,86400,%,$SUNR,LT,INF,UNKN,T1temp,*,IF \
CDEF:DRK1=LTIME,86400,%,$DUSK,GT,INF,UNKN,T1temp,*,IF \
CDEF:DRK2=LTIME,86400,%,$DAWN,LT,INF,UNKN,T1temp,*,IF \
AREA:TWL1$TWLC1 \
AREA:DRK1$DRKC1 \
AREA:TWL2$TWLC2 \
AREA:DRK2$DRKC2 \
...
${Hall} \
--title "HOL" \
DEF:T2temp=TH.rrd:T2:AVERAGE \
CDEF:TWL1=LTIME,86400,%,$SUNS,GT,INF,UNKN,T2temp,*,IF \
CDEF:TWL2=LTIME,86400,%,$SUNR,LT,INF,UNKN,T2temp,*,IF \
CDEF:DRK1=LTIME,86400,%,$DUSK,GT,INF,UNKN,T2temp,*,IF \
CDEF:DRK2=LTIME,86400,%,$DAWN,LT,INF,UNKN,T2temp,*,IF \
AREA:TWL1$TWLC1 \
AREA:DRK1$DRKC1 \
AREA:TWL2$TWLC2 \
AREA:DRK2$DRKC2 \
...
${Hall} \
--title "AFARA" \
DEF:T3temp=TH.rrd:T3:AVERAGE \
CDEF:TWL1=LTIME,86400,%,$SUNS,GT,INF,UNKN,T3temp,*,IF \
CDEF:TWL2=LTIME,86400,%,$SUNR,LT,INF,UNKN,T3temp,*,IF \
CDEF:DRK1=LTIME,86400,%,$DUSK,GT,INF,UNKN,T3temp,*,IF \
CDEF:DRK2=LTIME,86400,%,$DAWN,LT,INF,UNKN,T3temp,*,IF \
AREA:TWL1$TWLC1 \
AREA:DRK1$DRKC1 \
AREA:TWL2$TWLC2 \
AREA:DRK2$DRKC2 \
...
${Hall} \
--title "BECI" \
DEF:T4temp=TH.rrd:T4:AVERAGE \
CDEF:TWL1=LTIME,86400,%,$SUNS,GT,INF,UNKN,T4temp,*,IF \
CDEF:TWL2=LTIME,86400,%,$SUNR,LT,INF,UNKN,T4temp,*,IF \
CDEF:DRK1=LTIME,86400,%,$DUSK,GT,INF,UNKN,T4temp,*,IF \
CDEF:DRK2=LTIME,86400,%,$DAWN,LT,INF,UNKN,T4temp,*,IF \
AREA:TWL1$TWLC1 \
AREA:DRK1$DRKC1 \
AREA:TWL2$TWLC2 \
AREA:DRK2$DRKC2 \
...
${Hall} \
--title "APA RECE" \
DEF:T5temp=TH.rrd:T5:AVERAGE \
CDEF:TWL1=LTIME,86400,%,$SUNS,GT,INF,UNKN,T5temp,*,IF \
CDEF:TWL2=LTIME,86400,%,$SUNR,LT,INF,UNKN,T5temp,*,IF \
CDEF:DRK1=LTIME,86400,%,$DUSK,GT,INF,UNKN,T5temp,*,IF \
CDEF:DRK2=LTIME,86400,%,$DAWN,LT,INF,UNKN,T5temp,*,IF \
AREA:TWL1$TWLC1 \
AREA:DRK1$DRKC1 \
AREA:TWL2$TWLC2 \
AREA:DRK2$DRKC2 \
...
${Hall} \
--title "APA CALDA" \
DEF:T6temp=TH.rrd:T6:AVERAGE \
CDEF:TWL1=LTIME,86400,%,$SUNS,GT,INF,UNKN,T6temp,*,IF \
CDEF:TWL2=LTIME,86400,%,$SUNR,LT,INF,UNKN,T6temp,*,IF \
CDEF:DRK1=LTIME,86400,%,$DUSK,GT,INF,UNKN,T6temp,*,IF \
CDEF:DRK2=LTIME,86400,%,$DAWN,LT,INF,UNKN,T6temp,*,IF \
AREA:TWL1$TWLC1 \
AREA:DRK1$DRKC1 \
AREA:TWL2$TWLC2 \
AREA:DRK2$DRKC2 \
